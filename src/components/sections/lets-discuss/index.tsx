...
import { useContactForm } from "@/hooks/api/useContactUs";
...
const ContactFormSection = () => {
  ...
  return (
    ...
    >
      <div className="max-width-section w-full grid lg:grid-cols-2 gap-10 lg:gap-12">
        {/* Left Side - Content */}
        ...
        {/* Right Side - Form */}
        <div className="sm:min-h-[696px] min-h-[600px] flex items-start lg:items-center w-full">
          <form
