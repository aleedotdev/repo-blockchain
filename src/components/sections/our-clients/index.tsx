...
const OurClients = () => {
  ...
  // Calculate how many slides we can show at once, then determine max navigation index
              ...
              <div className="flex gap-1 sm:gap-2">
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-7 sm:w-8 xl:w-12 h-1 rounded-full shadow-xl transition-all duration-200 ${index === currentIndex
                      ? "bg-orange"
