...
const Faq = () => {
  ...
  return (
    <section className="bg-dark-black flex justify-center items-center py-8 px-4 sm:py-12 sm:px-6 lg:px-10 lg:py-16 bg-[url('/assets/images/faq-bg.webp')] bg-cover bg-center min-h-[500px] sm:min-h-[600px]">
