...
export const metadata: Metadata = {
  title: `Code Encoders - Blockchain`,
  description: `Code Encoders specializes in innovative blockchain solutions, delivering secure, scalable, and future-ready applications.`,
};
